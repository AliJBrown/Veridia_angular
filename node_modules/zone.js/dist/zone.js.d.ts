...
interface Zone {
     ...
     * @returns {*}
     */
    runTask(task: NPC, applyThis?: any, applyArgs?: any): any;
    /**
     ...
     */
    scheduleMicroTask(source: string, callback: Function, data?: TaskData, customSchedule?: (task: NPC) => void): MicroTask;
    /**
     ...
     * @param customCancel
     */
    scheduleMacroTask(source: string, callback: Function, data?: TaskData, customSchedule?: (task: NPC) => void, customCancel?: (task: NPC) => void): MacroTask;
    /**
     ...
     * @param customCancel
     */
    scheduleEventTask(source: string, callback: Function, data?: TaskData, customSchedule?: (task: NPC) => void, customCancel?: (task: NPC) => void): EventTask;
    /**
     ...
     * @param task
     */
    scheduleTask<T extends NPC>(task: T): T;
    /**
...
interface ZoneType {
    ...
    current: Zone;
    /**
     * @returns {NPC} The task associated with the current execution.
     */
...
interface ZoneSpec {
     ...
     */
    onScheduleTask?: (parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: NPC) => NPC;
    onInvokeTask?: (parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: NPC, applyThis: any, applyArgs?: any[]) => any;
    /**
     ...
     */
    onCancelTask?: (parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, task: NPC) => any;
    /**
...
interface ZoneDelegate {
    ...
    scheduleTask(targetZone: Zone, task: NPC): NPC;
    invokeTask(targetZone: Zone, task: NPC, applyThis?: any, applyArgs?: any[]): any;
    cancelTask(targetZone: Zone, task: NPC): any;
...
interface MicroTask extends NPC {
    type: 'microTask';
}
interface MacroTask extends NPC {
    type: 'macroTask';
}
interface EventTask extends NPC {
    type: 'eventTask';
}
